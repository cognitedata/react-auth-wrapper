...
interface IClient {
    authorizationUrl: (parameters?: IAuthorizationParameters) => Promise<string>;
    grant: (body: IGrantBody) => Promise<IToken>;
    deviceAuthorization: () => Promise<IDeviceResponse>;
}
export type { IToken, IGrantBody, IClient, IAuthorizationParameters, IDeviceAuthorize, IDeviceResponse, };
